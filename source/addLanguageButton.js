var 凸 = (function(凸) {
    ...
    凸.buttonLocation = function buttonLocation() {
        return document.getElementsByClassName("PageList");
    };
    ...
    凸.removeFirstElementIfExist = function removeFirstElementIfExist(className) {
        if (document.getElementsByClassName(className).length > 0) {
            凸.remove(document.getElementsByClassName(className)[0]);
        }
    };
    ...
    凸.addLanguageButton = function addLanguageButton() {
        凸.removeFirstElementIfExist("languageSwitch");
        var elem = 凸.buttonLocation(),
